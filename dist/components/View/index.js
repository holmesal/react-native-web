...
this.props,pointerEvents=_props.pointerEvents,style=_props.style,accessibilityComponentType=_props.accessibilityComponentType,accessibilityTraits=_props.accessibilityTraits,collapsable=_props.collapsable,hitSlop=_props.hitSlop,onAccessibilityTap=_props.onAccessibilityTap,onLayout=_props.onLayout,onMagicTap=_props.onMagicTap,removeClippedSubviews=_props.removeClippedSubviews,other=_objectWithoutProperties(_props,['pointerEvents','style','accessibilityComponentType','accessibilityTraits','collapsable','hitSlop','onAccessibilityTap','onLayout','onMagicTap','removeClippedSubviews']);
